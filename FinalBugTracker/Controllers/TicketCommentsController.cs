...
namespace FinalBugTracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,AuthorId,Body,Created,Updated,UpdateReason")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,AuthorId,Body,Created,Updated,UpdateReason")] TicketComment ticketComment)
        {
            if (ModelState.IsValid)
            {
